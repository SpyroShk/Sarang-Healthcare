...
class GroupField(serializers.Field):
    def to_representation(self, value):
        group_names = [group['name'] for group in value.values()]
        return group_names
...
class TokenSerializer(serializers.ModelSerializer):
    ...
    isStaff = serializers.BooleanField(source='user.is_staff')
    groups = GroupField(source='user.groups')

    class Meta:
        model = TokenModel
        fields = ('key', 'isStaff', 'groups')
