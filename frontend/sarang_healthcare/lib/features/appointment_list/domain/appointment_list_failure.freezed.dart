...
part of 'appointment_list_failure.dart';
...
/// @nodoc
mixin _$AppointmentListFailure {
  @optionalTypeArgs
...
/// @nodoc
abstract class $AppointmentListFailureCopyWith<$Res> {
  factory $AppointmentListFailureCopyWith(AppointmentListFailure value,
          $Res Function(AppointmentListFailure) then) =
      _$AppointmentListFailureCopyWithImpl<$Res, AppointmentListFailure>;
}

/// @nodoc
class _$AppointmentListFailureCopyWithImpl<$Res,
        $Val extends AppointmentListFailure>
    implements $AppointmentListFailureCopyWith<$Res> {
  _$AppointmentListFailureCopyWithImpl(this._value, this._then);
...
class __$$_ServerCopyWithImpl<$Res>
    extends _$AppointmentListFailureCopyWithImpl<$Res, _$_Server>
...
class _$_Server implements _Server {
  ...
  @override
  String toString() {
    return 'AppointmentListFailure.server()';
  }
...
abstract class _Server implements AppointmentListFailure {
...
class __$$_StorageCopyWithImpl<$Res>
    extends _$AppointmentListFailureCopyWithImpl<$Res, _$_Storage>
...
class _$_Storage implements _Storage {
  ...
  @override
  String toString() {
    return 'AppointmentListFailure.storage()';
  }
...
abstract class _Storage implements AppointmentListFailure {
...
class __$$_NetworkCopyWithImpl<$Res>
    extends _$AppointmentListFailureCopyWithImpl<$Res, _$_Network>
...
class _$_Network implements _Network {
  ...
  @override
  String toString() {
    return 'AppointmentListFailure.network()';
  }
...
abstract class _Network implements AppointmentListFailure {
...
class __$$_ClientCopyWithImpl<$Res>
    extends _$AppointmentListFailureCopyWithImpl<$Res, _$_Client>
...
class _$_Client implements _Client {
  const _$_Client({required this.message});
  ...
  @override
  String toString() {
    return 'AppointmentListFailure.client(message: $message)';
  }
...
abstract class _Client implements AppointmentListFailure {
  const factory _Client({required final String message}) = _$_Client;
